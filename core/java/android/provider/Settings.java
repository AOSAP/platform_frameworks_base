...
-        */
        ...
        static {
            ...
            AOSAP_SETTINGS_VALIDATORS.put(USE_SLIM_RECENTS, BOOLEAN_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(RECENTS_MAX_APPS, ANY_INTEGER_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(RECENT_PANEL_GRAVITY, ANY_INTEGER_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(RECENT_PANEL_SCALE_FACTOR, ANY_INTEGER_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(RECENT_PANEL_FAVORITES, ANY_STRING_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(RECENT_PANEL_EXPANDED_MODE, ANY_INTEGER_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(RECENT_PANEL_BG_COLOR, ANY_INTEGER_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(RECENT_CARD_BG_COLOR, ANY_INTEGER_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(SLIM_RECENT_AICP_EMPTY_DRAWABLE, BOOLEAN_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(USE_RECENT_APP_SIDEBAR, BOOLEAN_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(RECENT_APP_SIDEBAR_CONTENT, ANY_STRING_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(RECENT_APP_SIDEBAR_DISABLE_LABELS, BOOLEAN_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(RECENT_APP_SIDEBAR_BG_COLOR, ANY_INTEGER_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(RECENT_APP_SIDEBAR_TEXT_COLOR, ANY_INTEGER_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(RECENT_APP_SIDEBAR_SCALE_FACTOR, ANY_INTEGER_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(RECENT_APP_SIDEBAR_OPEN_SIMULTANEOUSLY, BOOLEAN_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(SLIM_RECENTS_MEM_DISPLAY, BOOLEAN_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(SLIM_RECENTS_MEM_DISPLAY_LONG_CLICK_CLEAR, BOOLEAN_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(SLIM_RECENTS_ICON_PACK, ANY_STRING_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(SLIM_MEM_BAR_COLOR, ANY_INTEGER_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(SLIM_MEM_TEXT_COLOR, ANY_INTEGER_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(SLIM_RECENTS_CORNER_RADIUS, ANY_INTEGER_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(SLIM_RECENTS_BLACKLIST_VALUES, ANY_STRING_VALIDATOR);
            AOSAP_SETTINGS_VALIDATORS.put(SLIM_RECENT_ENTER_EXIT_ANIMATION, ANY_INTEGER_VALIDATOR);
        }
    }
